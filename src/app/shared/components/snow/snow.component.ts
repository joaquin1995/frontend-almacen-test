import { Component, Input, ElementRef, HostListener, ViewChild, Renderer2, AfterViewInit } from '@angular/core';

@Component({
  selector: 'app-snow',
  template: '<canvas #snowCanvas  class="snowf-canvas"></canvas>',
  styles: [`
    .snowf-canvas {
      position: absolute;
      /* position: fixed; */
...
export class SnowComponent implements AfterViewInit {
  ...
  @Input('zIndex') zIndex: number = 999999;
  ...
  ngAfterViewInit(): void {
    ...
    if (this.mostrarNavidad) {
      this.canvas = this.snowCanvas.nativeElement;
      //this.canvas = this.elementRef.nativeElement.querySelector('.snowf-canvas');
      console.log(this.canvas);
      console.log(this.snowCanvas.nativeElement);
      ...
      if (this.zIndex != null) {
        ...
        this.renderer2.setStyle(this.canvas, 'z-index', this.zIndex);
      }
  ...
  handleResize() {
    ...
    // console.log('handleResize', H0, W0, H1, W1);
